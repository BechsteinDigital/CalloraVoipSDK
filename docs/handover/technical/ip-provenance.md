...
- Strategische Vorgabe hierzu (verifiziert in `docs/SDK_PRODUCT_MEMORY.md`, Abschnitt „Strategic
...
- `docs/SDK_PRODUCT_MEMORY.md`, Abschnitt „Strategic Technology Direction" (Z. 54–57)
