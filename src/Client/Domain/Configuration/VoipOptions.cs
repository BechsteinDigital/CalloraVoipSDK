...
/// <summary>
/// Options model used by <c>AddCalloraVoip(...)</c> for host-based configuration.
/// </summary>
public sealed class VoipOptions
{
    ...
    /// <see cref="SipTransport.Udp"/>. See <see cref="VoipConfiguration.DefaultTransport"/>.
    /// </summary>
    ...
    /// See <see cref="VoipConfiguration.PreferredAudioCodecs"/> for semantics.
    /// </summary>
    public IReadOnlyList<string>? PreferredAudioCodecs { get; set; }

    /// <summary>
    /// Offer DTLS-SRTP keying (RFC 5763) on outbound media, not only SDES.
    /// See <see cref="VoipConfiguration.OfferDtlsSrtp"/> for semantics.
    /// </summary>
    ...
    /// See <see cref="VoipConfiguration.EnableVideo"/> for semantics.
    /// </summary>
    ...
    /// See <see cref="VoipConfiguration.PreferredVideoCodecs"/> for semantics.
    /// </summary>
    public IReadOnlyList<string>? PreferredVideoCodecs { get; set; }

    /// <summary>
    /// Audio format delivered to bridge/recording consumers.
    /// See <see cref="VoipConfiguration.BridgeAudioFormat"/> for semantics.
    /// </summary>
